...
async def broadcast_handler(message: types.Message):
    ...
    broadcast_text = (
        "Привіт! 😊 Як настрій?\n\n"
        "Досить працювати! Дай собі відпочити і перестань паритись через всякі дурниці\n"
        "Подумай, чи булде ця проблема важливою через 5 років?\n"
        "Якщо ні, то це просто фігня і не вартує того, щоб переживати, поглянь на проблему зі сторони\n"
        "Я завжди радий допомогти розслабитись і зарядитись енергією на масажі 💆‍♂️💆‍♀️\n\n"
        "🔔 Новинка! У мене зʼявилась *накопичувальна карта клієнта* 🔥\n"
        "✅ При кожному візиті ставлю відмітку, і *6-й масаж — БЕЗКОШТОВНО* (до 1 години)\n"
        "⚠️ Кількість карт обмежена — залишилось 5 штук!\n"
        "Приходь на масаж і забирай свою картку вже зараз 😉"
)
